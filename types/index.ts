export interface Concert {
  ...
  time: string | null
  neighborhood: string
  city: 'NYC' | 'LA' | 'SF' | 'CHI' | 'AUS' | 'SEA' | 'DC' | 'BOS' | 'DEN' | 'PDX' | 'FTW' | 'LOU' | 'ELP' | 'BHM' | 'ABQ' | 'ALB' | 'TUS' | 'TUC' | 'TLS' | 'TUL' | 'PIT' | 'RAH' | 'OKC' | 'SAT' | 'HNL' | 'CHR' | 'CHA' | 'STL' | 'BAL' | 'JAX' | 'OMA' | 'LB' | 'SD' | 'SBA' | 'ANA' | 'LV' | 'ARK' | 'NSH' | 'PHI' | 'MIA' | 'ATL' | 'MIN' | 'NOLA' | 'MEM' | 'DET' | 'TB' | 'DAL' | 'IND' | 'CMH' | 'CLE' | 'RDU' | 'BUF' | 'MIL' | 'CHS' | 'HOU' | 'KC' | 'ORL' | 'KNX' | 'AKR' | 'ROC' | 'SYR' | 'LEX' | 'HRT' | 'BOZ' | 'SAV' | 'CHT' | 'BR' | 'RIC' | 'PHX' | 'CIN' | 'PRV' | 'GRE' | 'RNO' | 'DAY' | 'TOL' | 'DES' | 'MAD' | 'GR' | 'ANN' | 'WIC' | 'COS' | 'FTC' | 'TAC' | 'SPO' | 'EUG' | 'BEN' | 'WPB' | 'SLO' | 'MTY' | 'SCZ' | 'ASH' | 'SAC' | 'SFE' | 'CHV' | 'NAP' | 'FLG' | 'BTV' | 'ICY' | 'PNS' | 'FAY' | 'PWM' | 'CAE' | 'HSV' | 'VB' | 'TLH'
  genre: string | null
  price: string
